    ...
    */
    ...
    const loadRequests = async () => {
        ...
        try {
            ...
            const response =
                await api.get(
                    "/school-admin/requests/parents"
                );
            
            console.log("ParentsRequests:",response.data.data)
    ...
    */
    ...
    const handleApprove = async (
        ...
        try {
            ...
            const response =
                await api.patch(
                    `/school-admin/requests/Parents/${requestId}/approve`
                );
            ...
            setError(
                error.response?.data?.message ||
                "Unable to approve Parents request."
            );
    ...
    */
    ...
    const handleReject = async (
        ...
        try {
            ...
            const response =
                await api.patch(
                    `/school-admin/requests/parents/${requestId}/reject`,
                    {
                        reason:
                            reason.trim() ||
            ...
            setError(
                error.response?.data?.message ||
                "Unable to reject parent request."
            );
                ...
                {requests.length === 0 && (
                    ...
                    <div className="rounded-3xl border border-base-300 bg-base-100 p-12 text-center shadow-sm">
                        ...
                        <p className="mx-auto mt-2 max-w-md text-sm text-base-content/50">
                            New parent registration requests
                            will appear here when parents
                            select your school.
                        </p>
