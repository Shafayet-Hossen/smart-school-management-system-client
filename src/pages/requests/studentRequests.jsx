    ...
    */
    ...
    const loadRequests = async () => {
        ...
        try {
            ...
            const response =
                await api.get(
                    "/school-admin/requests/students"
                );
            
            console.log("StudentRequests:",response.data.data)
    ...
    */
    ...
    const handleApprove = async (
        ...
        try {
            ...
            const response =
                await api.patch(
                    `/school-admin/requests/students/${requestId}/approve`
                );
            ...
            setError(
                error.response?.data?.message ||
                "Unable to approve student request."
            );
    ...
    */
    ...
    const handleReject = async (
        ...
        try {
            ...
            const response =
                await api.patch(
                    `/school-admin/requests/students/${requestId}/reject`,
                    {
                        reason:
                            reason.trim() ||
            ...
            setError(
                error.response?.data?.message ||
                "Unable to reject student request."
            );
                ...
                {requests.length === 0 && (
                    ...
                    <div className="rounded-3xl border border-base-300 bg-base-100 p-12 text-center shadow-sm">
                        ...
                        <p className="mx-auto mt-2 max-w-md text-sm text-base-content/50">
                            ...
                            will appear here when students
                            select your school.
                        </p>
